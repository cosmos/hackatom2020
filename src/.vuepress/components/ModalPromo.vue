  ...
  div
    modal(@input="$router.push('/#_')" :visible="true")
        ...
        .heading__container
          .heading__image
            .heading__image__container
              img(src="/ticket-back.svg" alt="Ticket Back").heading__image__img
      ...
      .body
        ...
        //- .body__buttons
        //-   a(:href="value.signup.url" target="_blank" rel="noreferrer noopenner").body__buttons__item {{$frontmatter.cta}}
        .body__smallprint(v-html="md($frontmatter.smallprint)")
      .footer
        .footer__container(v-html="md($frontmatter.tos)")
</template>
